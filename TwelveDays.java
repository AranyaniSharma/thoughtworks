...
class TwelveDays {
    String verse(int verseNumber) {
        ...
        String startingVerse="On the first day of Christmas my true love gave to me: ";
        
        String endingVerse="a Partridge in a Pear Tree.\n";
        if(verseNumber==1){
